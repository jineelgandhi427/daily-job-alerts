...
# -------------------- CONFIG -------------------- #
KEYWORDS = [
    "mechatronics", "simulation", "development", "test", "r&d", "robotics", 
    "automation", "systems engineer", "embedded", "validation", "hardware"
]
EXCLUDE = [
    "ausbildung", "praktikum", "werkstudent", "kfz", "trainee", "intern", "student"
]
